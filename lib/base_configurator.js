...
_.extend(BaseConfigurator.prototype, {
  ...
  /**
   * The name of the configuration collection in persistent mode.
   */
  configCollectionName: 'lag_console_config',
  ...
  initConfig: function(){
    ...
    if (configs.persist) {
      actualCollectionName = this.configCollectionName;
    }
  ...
  /**
   * Attempts to fetch the meteor settings for the configurator (set through json)
   * @returns {Object} The config options, or an empty object if none are found.
   * @private
   */
